        ...
        <div class="container">
            ...
            <div class="main-content row">
                ...
                <div class="left-content col-sm-6">
                    ...
                    <p>With the rising popularity of superhero movies there has been a heightened awareness of superheroes in our midst.  The frequency of superhero (and supervillain) sightings is increasing at an alarming rate.</p>

                    <p>The Hero Education and Relationship Organization (HERO) is providing a new super hero sightings web application to track these sightings.</p>
                </div>

                <div class="right-content  col-sm-6">
                    <h2>10 Most Recent Sightings: </h2>
                    <p>(Click the link to view sighting details)</p>

                    <table id="hero-list" class="table table-hover">

                        <c:forEach var="current" items="${recentTenList}">
                            <tr>
                                <td>
                                    <a href="displaySightingDetails?sightingId=${current.sightingId}">
                                        <c:out value="${current.sightingDate}"/>
                                    </a>
                                </td>
