<%-- 
    ...
    Created on : Oct 20, 2018, 10:02:10 PM
    Author     : timpinkerton
--%>
                    ...
                    <table id="hero-list" class="table table-hover">
                        ...
                        <c:forEach var="currentSuperpower" items="${superpowerList}">
                            <tr>
                                ...
                                <!--Removing hero list from the view-->
                                
<!--                                <td>
                                    <ul>
                                        <c:forEach var="currentHero" items="${currentSuperpower.heroes}">
                ...
                <div class="right-content  col-lg-6">
                    <div>
                        <h2>Add a new Superpower:</h2>
                    </div>
                    <form role="form" method="POST" action="createSuperpower">
                        <div class="form-group">
                            <label for="superpowerInput">Superpower:</label>
                            <input type="text" class="form-control" name="superpowerInput" id="superpowerInput" aria-describedby="superpower" placeholder="Enter a superpower" required>
                        </div>
                        <div class="form-group">
                            <label for="descriptionInput">Select Heroes that have this Superpower:</label>
                            <select multiple class="form-control" name="selectedHeroes" id="heroList">
                                <c:forEach var="currentHero" items="${heroList}">
                                <option value="${currentHero.heroId}"><c:out value="${currentHero.heroName}"/></option>
                                </c:forEach>
                            </select>
                        </div>
                        <button type="submit" class="btn btn-primary" value="Create Superpower">Submit</button>
                    </form>
