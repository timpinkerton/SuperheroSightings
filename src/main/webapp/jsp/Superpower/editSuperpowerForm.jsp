<%-- 
    ...
    Created on : Oct 21, 2018, 11:10:54 AM
    Author     : timpinkerton
--%>
        ...
        <div class="container">
            ...
            <div class="main-content row"> 
                ...
                <div class="left-content col-lg-6">
                    <p>Current superpower information:</p>

                    <h2><c:out value="${superpower.description}"/></h2>
                ...
                <div class="right-content col-lg-6">
                    ...
                    <form class="form-horizontal" role="form" 
                        ...
                        <div class="form-group">
                            <label for="superpower" class="col-md-8 control-label">Superpower:</label>
                            <input type="text" class="form-control" name="superpower" id="add-superpower"/>
                        </div>

                        <div class="form-group">
                            <label for="add-description" class="col-md-8 control-label">Select the Heroes with this Superpower:</label>
                            ...
                            <input type="hidden" id="superpowerId" name="superpowerId" value="${superpower.superpowerId}">
                        </div>

                        <div class="form-group">
                            <div class="col-md-offset-4 col-md-8">
                                <button type="submit" class="btn btn-primary" value="Update Superpower">Update</button>
                            </div>
                        </div>
                    </form>
                </div>
